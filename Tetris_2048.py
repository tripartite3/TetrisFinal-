...
from color import Color, WHITE, LIGHT_GRAY, CUSTOM  # used for coloring the game menu
...
def start():
    ...
    canvas_h, canvas_w = 45 * grid_h, 50 * grid_w
    ...
    while True:
        ...
        if stddraw.hasNextKeyTyped():
            ...
            # if the down arrow key has been pressed
                ...
                stddraw.clear(c=CUSTOM)
                stddraw.pauseText(5.5, 10, 'Paused for 10 seconds.')
                stddraw.show(msec=float('10000'))
        ...
        if not success:
            ...
            if game_over:
                stddraw.clear(c=CUSTOM)
                stddraw.pauseText(5.5, 10, 'Game Over!')
                stddraw.show(msec=float(5))
                time.sleep(5)
                break
...
def display_game_menu(grid_height, grid_width):
    ...
    button_color = Color(150, 155, 150)
    ...
    stddraw.setFontFamily("Sans")
    stddraw.setFontSize(50)
    stddraw.setPenColor(text_color)
    text_to_display = "Click to Start!"
